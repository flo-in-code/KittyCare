...
function Sidebar({cats, selectedCatId, setSelectedCatId, addCats, deleteCat, updateCat}) {
    ...
    return (
        <div className="bg-white py-8 w-52">
            ...
            <div className='w-full px-3 my-2'>
                <CatSelector cats={cats} selectedCatId={selectedCatId} setSelectedCatId={setSelectedCatId} addCats={addCats} deleteCat={deleteCat} updateCat={updateCat} />
            </div>
